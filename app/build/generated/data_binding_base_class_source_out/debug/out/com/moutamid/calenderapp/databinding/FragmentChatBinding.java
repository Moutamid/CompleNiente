...
public final class FragmentChatBinding implements ViewBinding {
  ...
  private FragmentChatBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView RC,
      @NonNull LinearLayout noItemLayout) {
  ...
  public static FragmentChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChatBinding((LinearLayout) rootView, RC, noItemLayout);
    }
