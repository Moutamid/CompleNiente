...
public final class LoadingDialogBinding implements ViewBinding {
  ...
  private LoadingDialogBinding(@NonNull MaterialCardView rootView, @NonNull TextView message) {
  ...
  public static LoadingDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoadingDialogBinding((MaterialCardView) rootView, message);
    }
