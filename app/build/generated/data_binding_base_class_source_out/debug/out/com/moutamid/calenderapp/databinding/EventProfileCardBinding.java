...
public final class EventProfileCardBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static EventProfileCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EventProfileCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.event_profile_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EventProfileCardBinding bind(@NonNull View rootView) {
